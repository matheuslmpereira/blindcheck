...
Numa captura controlada de TTS em emulador (API 36, Google TalkBack), a sequência falada logo após
a ativação é `Continuar → Button → Double-tap to activate`: o mesmo rótulo que a pessoa acabou de
ouvir na tela anterior. Com o reset, a mesma transição fala apenas o primeiro item do novo destino.
